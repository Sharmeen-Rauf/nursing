    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] font-bold mb-6 leading-tight">
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[48px] font-bold text-gray-900 mb-4">Our Services</h2>
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-200 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[48px] font-bold text-gray-900 mb-4">Why Choose Us</h2>
          </div>
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-300 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[48px] font-bold text-gray-900 mb-4">Featured Services</h2>
          </div>
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-200 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[56px] font-bold text-gray-900 mb-4">How It Works</h2>
          </div>
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-300 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[56px] font-bold text-gray-900 mb-4">Client Reviews</h2>
          </div>
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-200 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[56px] font-bold text-gray-900 mb-4">Care Packages</h2>
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-300 ${
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-[32px] sm:text-[40px] lg:text-[56px] font-bold text-gray-900 mb-6">About Us</h2>
      ...
      <section className="relative py-10 lg:py-12 bg-white flex items-center justify-center min-h-[50vh]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[56px] font-bold text-gray-900 mb-4">Our Care in Action</h2>
      ...
      >
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-200 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[56px] font-bold text-gray-900 mb-4">Safety Protocols</h2>
      ...
      >
        <div className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-300 ${
          ...
          <div className="text-center mb-10">
            <h2 className="text-[32px] sm:text-[40px] lg:text-[56px] font-bold text-gray-900 mb-4">Request a Home Visit</h2>
